...
mjolnir._asm.notify = require "mjolnir._asm.notify"
mjolnir.applescript = require("mjolnir._asm.hydra.applescript")

--
-- Set the grid size and configuration.
--
...
function killnotify()
    aplstr = "tell application \"Growl\"\n close all notifications\n end tell"
    applescript(aplstr)
end
mjolnir.hotkey.bind({"ctrl", "shift"},"g", killnotify)
...
mjolnir.hotkey.bind({"cmd", "alt", "ctrl"}, "v", function()
  mjolnir.alert.show("you did something!")
end)
--
